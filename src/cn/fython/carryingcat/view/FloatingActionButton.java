...
public class FloatingActionButton extends View implements Animator.AnimatorListener {
    ...
    public FloatingActionButton(Context context, OnAnimationFinishedListener listener) {
        super(context);
    ...
    public void onAnimationEnd(Animator anim) {
        ...
        if (listener != null) listener.onFinished(!mHidden);
    }
    ...
    public interface OnAnimationFinishedListener {
        ...
        public void onFinished(boolean isShowed);
    ...
    static public class Builder {
        ...
        public Builder(Activity context) {
            ...
            size = convertToPixels(85, scale); // default size is 85dp by 85dp
        ...
        public FloatingActionButton create() {
            final FloatingActionButton button = new FloatingActionButton(activity, listener);
